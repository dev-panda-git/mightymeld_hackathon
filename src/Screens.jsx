      ...
      <div className="pt-[8vh] md:pt-0 flex flex-col gap-4">
        <div className="flex justify-between items-end   w-full ">
          <p
            ...
            className=" md:h-[100px] md:w-[100px] h-[78px] w-[78px] text-right flex flex-col items-center justify-center rounded-xl text-black  bg-white "
          >
            <span className=" text-4xl font-bold ">{tryCount}</span>
            <span>tries</span>
          </p>
          <p className=" md:h-[100px] md:w-[100px] h-[78px] w-[78px] text-right flex flex-col items-center justify-center rounded-xl text-black bg-gradient-to-br from-pink-400 to-indigo-400 ">
